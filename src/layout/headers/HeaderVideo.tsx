            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-9 col-lg-9 col-md-6 col-6">
                <div className="header-right f-right">
                  <div className="header-social-icons header-social-icons-3 f-right d-none d-xl-block">
                    <ul>
                      <li><SocialLinks /> </li>
                    </ul>
                  </div>
